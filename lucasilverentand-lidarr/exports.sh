api_key_file="${EXPORTS_APP_DATA_DIR}/.lidarr-api-key"
...
export LUCASILVERENTAND_LIDARR_URL="http://lucasilverentand-lidarr_server_1:8686"
export LUCASILVERENTAND_LIDARR_API_KEY="$(cat "$api_key_file")"
