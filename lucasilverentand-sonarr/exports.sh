api_key_file="${EXPORTS_APP_DATA_DIR}/.sonarr-api-key"
...
export LUCASILVERENTAND_SONARR_URL="http://lucasilverentand-sonarr_server_1:8989"
export LUCASILVERENTAND_SONARR_API_KEY="$(cat "$api_key_file")"
