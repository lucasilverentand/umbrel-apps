api_key_file="${EXPORTS_APP_DATA_DIR}/.radarr-api-key"
...
export LUCASILVERENTAND_RADARR_URL="http://lucasilverentand-radarr_server_1:7878"
export LUCASILVERENTAND_RADARR_API_KEY="$(cat "$api_key_file")"
